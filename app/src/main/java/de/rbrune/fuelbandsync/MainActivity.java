...
public class MainActivity extends AppCompatActivity {
    ...
    public static final String TAG = "Fuelbandsync";
    ...
    private FuelbandsyncDatabase mydb;
    ...
    private class InsertAndVerifyDataTask extends AsyncTask<Void, Void, Void> {
        protected Void doInBackground(Void... params) {
            ...
            ArrayList<Long> unsyncedData = mydb.getAllUnsyncedDatapoints();
            if (unsyncedData.size() <= 0) return null;
            ...
            for (Long endtime : unsyncedData) {
                mydb.updateDatapointSync(endtime, 1);
            }
            Log.i(TAG, "Removed unsynced flag from all unsynced data!");
    ...
    private DataSet insertFitnessData() {
        ...
        ArrayList<Long> unsyncedData;
        unsyncedData = mydb.getAllUnsyncedDatapoints();

        //mydb.updateDatapointSync(test.get(0), 0);
        Long starttime = 0L;
        for (Long endtime : unsyncedData) {
            ContentValues contentValues = mydb.getDatapoint(endtime);
            ...
            if (steps > 0) {
                if (endtime - starttime > 5*60*1000) starttime = endtime - 5*60*1000;
